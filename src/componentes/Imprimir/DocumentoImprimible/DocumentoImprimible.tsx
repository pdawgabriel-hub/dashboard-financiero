...
export default function DocumentoImprimible({ children }: DocumentoImprimibleProps) {
  return (
    <div className="min-h-screen bg-slate-950 print:bg-white print:min-h-0 pb-10 print:pb-0">
      <div className="max-w-3xl mx-auto bg-white text-slate-900 rounded-2xl shadow-xl p-8 sm:p-10 print:shadow-none print:rounded-none print:p-0 print:max-w-none">
        {children}
      </div>
    </div>
  );
